...
/**
 * STORE OWNER - PENDING ORDER DETAILS
 *
 * Figma File: 8I1Nr3vQZllDDknSevstvH
 * Node: 1057-4876 (Pending/Order Details)
 * Baseline: 440x956
 *
 * Screen #2 of 7 - Store Order Management
 * Shows full order details for pending orders with Accept/Reject actions
 * Navigation: Orders (Pending) → Click order → This screen
 *
 * Actions:
...
export default function OrderDetailsPendingScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        {/* REJECT BUTTON - Custom addition for reject action */}
        <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  // REJECT BUTTON - Custom addition (positioned below Accept button)
  rejectButton: {
    position: "absolute",
    left: s(20),
  ...
  bottomPadding: {
    height: vs(1050), // Adjusted to include both buttons
  },
});
