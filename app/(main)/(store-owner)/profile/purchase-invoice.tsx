          ...
          <View style={styles.detailsCard}>
            ...
            <View style={styles.detailRow}>
              ...
              <View style={styles.paymentBadgeContainer}>
                <View style={[
                  styles.paymentBadge,
                  { backgroundColor: (paymentMethodParam || purchaseOrder.paymentMethod) === 'debt' ? '#FFF3E0' : '#E8F5E9' }
                ]}>
                  <Text style={[
                    styles.paymentBadgeText,
                    { color: (paymentMethodParam || purchaseOrder.paymentMethod) === 'debt' ? '#FF8D2F' : '#4CAF50' }
                  ]}>
                    {(paymentMethodParam || purchaseOrder.paymentMethod) === 'debt' ? '💳 DEBT' : '💵 CASH (Paid)'}
                  </Text>
                </View>
              </View>
            </View>
