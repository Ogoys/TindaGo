...
export default function InventoryDashboardScreen() {
  ...
  const handleNavigate = (screen: string) => {
    switch (screen) {
      ...
      case 'low-stock':
        router.push({
          pathname: '/(main)/(store-owner)/profile/store-product',
      ...
      >
        ...
        <View style={styles.actionsSection}>
          ...
          <View style={styles.actionsGrid}>
            ...
            <TouchableOpacity 
              style={styles.actionButton}
              onPress={() => router.push('/(main)/(store-owner)/profile/store-product')}
            >
              <Text style={styles.actionIcon}>📝</Text>
            ...
            >
              <Text style={styles.actionIcon}>📥</Text>
              <Text style={styles.actionText}>Purchase Order</Text>
            </TouchableOpacity>
