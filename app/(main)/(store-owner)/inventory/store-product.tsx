...
const StoreProductScreen = () => {
  ...
  const initialFilter = (params.filter as 'all' | 'in-stock' | 'low-stock' | 'out-of-stock') || 'all';
  ...
  const [selectedStockFilter, setSelectedStockFilter] = useState<'all' | 'in-stock' | 'low-stock' | 'out-of-stock'>(initialFilter);
